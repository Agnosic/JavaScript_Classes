...
function check(filepath, response) {
...
http.createServer(function(request, response) {
    ...
    */
    ...
    if(url_parts.pathname == '/submit') { //Processing the form content, if the relative URL is '/ submit'
        var filepath=url_parts.query['name']; //Read the contents of the field (form) named 'name'
        ...
        check(filepath, response); //Place given data (here: 'Hello' text) in the body of the answer
        ...
        response.write('<label for="name">Give your file path</label>');
